...
def detectron_predict(img, model):
    img = img.img

    if model=='invitro':
		model_dir='/camp/home/ritot/working/tiago/Nucleus/models/micropatterns/model_final.pth'
		config_fn='Misc/cascade_mask_rcnn_X_152_32x8d_FPN_IN5k_gn_dconv.yaml'
	elif model=='SC_sections':
		model_dir='/camp/home/ritot/working/tiago/Nucleus/models/SC_sections/model_final.pth'
